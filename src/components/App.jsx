...
import TradeRequestWindow from "./ui/center_panel/trade/TradeRequestWindow";
...
export default function App() {
  ...
  const renderCenterPanel = () => {
    switch (centerPanel) {
      ...
      case "partyInvites":
        return <PartyInvites />;
      case "tradeRequestWindow":
        return <TradeRequestWindow />;
      default:
        return null;
    }
  };
          ...
          <div
            className={`centerPanel ${
              centerPanel === "chatWindow"
                ? "centerPanelChat"
                : centerPanel === "partyWindow"
                  ? "centerPanelParty"
                  : centerPanel === "encounterInfo"
                    ? "centerPanelEncounterInfo"
                    : centerPanel === "shopWindow"
                      ? "centerPanelShop"
                      : centerPanel === "partyInvites"
                        ? "centerPanelPartyInvites"
                        : centerPanel === "tradeWindow"
                          ? "centerPanelTrade"
                          : centerPanel === "tradeRequestWindow"
                            ? "centerPanelTradeRequests"
                            : ""
            }`}
          >
            {renderCenterPanel()}
