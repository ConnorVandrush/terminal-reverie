...
export default function TradeRequestWindow() 
{
    ...
    const tradeRequests = useSelector(state => state.tradeWindow.tradeRequests || []);
    const errorMessage = useSelector(state => state.tradeWindow.errorMessage || null);
    const successMessage = useSelector(state => state.tradeWindow.successMessage || null);
                    ...
                    tradeRequests.map(request => (
                        ...
                        >
                            ...
                            <button 
                                ...
                                onClick={() => dispatch(removeTradeRequest(request.fromPlayerName))}
                            >
                                Decline
                            </button>
                        </div>
