...
export default function TradeWindow() {
  ...
  const playerName =
    window.clientGlobalManager.clientPlayerManager.characterData.name;

  const tradePartner = useSelector((state) => state.tradeWindow.tradePartner);
  const theirOfferItems =
    useSelector((state) => state.tradeWindow.theirOfferItems) || {};
  const yourOfferItems =
    useSelector((state) => state.tradeWindow.yourOfferItems) || {};
  const theirOfferGold = useSelector(
    (state) => state.tradeWindow.theirOfferGold,
  );
  ...
  const successMessage = useSelector(
    (state) => state.tradeWindow.successMessage,
  );
    ...
    <div className={styles.tradeWindow}>
      <div className={styles.offers}>
        ...
        <div className={styles.theirOffer}>
          ...
          {theirOfferGold > 0 && (
            <div className={styles.theirGoldOffer}>{theirOfferGold} gold</div>
          )}
        ...
        <div className={styles.yourOffer}>
          ...
          {yourOfferGold > 0 && (
            <div className={styles.yourGoldOffer}>{yourOfferGold} gold</div>
          )}
      ...
      <div className={styles.offerActions}>
        <div className={styles.offerItems}>
          ...
          <button
            ...
            onClick={handleClientOfferItemInTrade}
          >
            Set Item Quantity
          </button>
        </div>
        ...
        <div className={styles.offerGold}>
          ...
          <button
            className={styles.addItemButton}
            onClick={handleClientOfferGoldInTrade}
          >
            Set Gold Amount
          </button>
        </div>
      ...
      <div className={styles.tradeActions}>
        <button
          ...
          onClick={() => dispatch(clientTradeAccepted())}
        >
          Accept
        </button>
        <button
          className={styles.declineButton}
          onClick={() => dispatch(clientTradeDeclined())}
        >
          Decline
        </button>
      </div>
