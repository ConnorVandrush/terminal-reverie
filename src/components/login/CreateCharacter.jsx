...
import { setName, setOrigin, setJob, setGender, setHairStyle, setClothingStyle } from '@store/createCharacterSlice';
        ...
        <div className={styles.createCharacter}>
            ...
            <h3>Create Character</h3>
                ...
                <div>
                    ...
                    <select id="origin" name="origin" value={origin} className={styles.input} onChange={(e) => dispatch(setOrigin(e.target.value))}>
                ...
                <div>
                    ...
                    <select id="job" name="job" value={job} className={styles.input} onChange={(e) => dispatch(setJob(e.target.value))}>
                ...
                <div>
                    ...
                    <select id="gender" name="gender" value={gender} className={styles.input} onChange={(e) => dispatch(setGender(e.target.value))}>
                ...
                <div>
                    ...
                    <select id="hairStyle" name="hairStyle" value={hairStyle} className={styles.input} onChange={(e) => dispatch(setHairStyle(e.target.value))}>
                ...
                <div>
                    ...
                    <select id="clothingStyle" name="clothingStyle" value={clothingStyle} className={styles.input} onChange={(e) => dispatch(setClothingStyle(e.target.value))}>
                        <option value="style1">Style 1</option>
                        <option value="style2">Style 2</option>
                        <option value="style3">Style 3</option>
                    </select>
