class ClientBattleSpriteColorer {
    constructor() {
    ...
    recolorSpritesheet(imageSrcOrImg, templateName, colorChoices) {
        return this.recolorSprite(imageSrcOrImg, templateName, "battleHair", colorChoices.hair)
            .then(recoloredHair => this.recolorSprite(recoloredHair, templateName, "battleEyes", colorChoices.eyes))
            .then(recoloredEyes => this.recolorSprite(recoloredEyes, templateName, "battleSkin", colorChoices.skin))
            .then(recoloredSkin => this.recolorSprite(recoloredSkin, templateName, "battleShirt", colorChoices.shirt))
            .then(recoloredShirt => this.recolorSprite(recoloredShirt, templateName, "battlePants", colorChoices.pants));
    }
}

// Assign globally
window.clientGlobalManager.clientPlayerManager.battleSpriteColorer = new ClientBattleSpriteColorer();